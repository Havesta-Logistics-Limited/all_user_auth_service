...
module.exports = async (req, res, next) => {
  try {
    ...
    if (!authHeader || !authHeader.startsWith("Bearer ")) {
      return responseHandler.forbidden(res, "Token missing or malformed. Please log in again.");
    }
    ...
    res.locals.user = decodedToken.PUID;
    if (!decodedToken) {
      return responseHandler.forbidden(res, "Invalid session, please log in again.");
    }
